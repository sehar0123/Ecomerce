...
const Button = ({
  ...
  buttonColor = globalStyles.Theme.PrimaryColor, ///Color of button which is by default theme color of app.
  ...
  imgWidth = 28,
  borderWidth = 0.5,
  borderColor = globalStyles.Theme.PrimaryColor, ///Defines the border color of button.
