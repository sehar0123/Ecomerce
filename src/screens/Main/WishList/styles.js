...
//    textAlign:'center',
  ...
  inputFeild: {
    ...
    marginLeft: 10,
    marginBottom: 10,
  },space:{ justifyContent:'space-around',backgroundColor:globalStyles.Theme.backgroundColor,shadowColor: "#000",borderRadius:20*fontRef,height:40*heightRef,width:'50%',flexDirection:'row',
  shadowOffset: {
      width: 0,
      height: 2,
  },
  ...
  marginRight:50*widthRef,
      },view:{height:100,justifyContent:'space-around',width:'76%'},footer:{
        backgroundColor: globalStyles.Theme.backgroundColor,
        width:'100%',
      padding:10*heightRef,
